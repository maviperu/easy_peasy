...
# --- Setup Runner and Session --- # To delete?
...
# --- Function to Interact with the Agent --- # To delete?
...
runner = Runner(agent=story_flow_agent, session_service=session_service, app_name="default")
...
if __name__ == "__main__":
    try:
        ...
        asyncio.run(call_agent_async("two toddlers playing with a kitten"))
